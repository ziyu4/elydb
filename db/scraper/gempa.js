...
; (async () => {
  ...
  await fs.writeFileSync('./db/src/information/gempa_terkini.json', JSON.stringify(result, null, 2))
})()
...
; (async () => {
  ...
  await fs.writeFileSync('./db/src/information/gempa_dirasakan.json', JSON.stringify(result, null, 2))
})()
